...
public class Consumer2 {
    public static void main(String[] args) throws Exception {
        ...
        channel.exchangeDeclare("zx_direct", BuiltinExchangeType.DIRECT,true,false,null);
        ...
        channel.queueDeclare("zx_queue_d2", true, false, false, null);
        ...
        channel.basicConsume("zx_queue_d2",false,new DefaultConsumer(channel){
            @Override
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                try {
                    String message = new String(body,"utf-8");
                    System.out.println(Consumer2.class.getSimpleName()+"--接收消息--"+message);
